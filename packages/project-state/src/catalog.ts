...
export const MODULE_CATALOG: Record<ModuleType,ModuleSpec> = {
  base_cabinet_doors:{allowedWidths:"tenant_standard",defaultHeight:720,defaultDepth:560},base_cabinet_drawers:{allowedWidths:"tenant_standard",defaultHeight:720,defaultDepth:560},sink_cabinet:{allowedWidths:"tenant_standard",defaultHeight:720,defaultDepth:560},

...
- **3D governance синхронизирован решением владельца (2026-08-19):** FOUNDATION.md §5.4 принял ADR-005 как ограниченное исключение (ленивый опциональный viewer, SVG-first core и запрет «полноценного 3D» сохраняются); AGENTS.md ссылается на то же исключение. Один источник истины восстановлен.
